...
class Recipe(db.Model):
    ...
    image_url = db.Column(db.String(255), nullable=True) # Changed to nullable=True as GPT might not always generate
    calories = db.Column(db.Integer, nullable=True) # Changed to nullable=True
